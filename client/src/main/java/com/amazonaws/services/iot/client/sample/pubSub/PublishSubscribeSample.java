...
public class PublishSubscribeSample {
    ...
    public static void publishDatatoCloud(String args[]) throws InterruptedException, AWSIotException, AWSIotTimeoutException {
          ...
          blockingPublishThread.setDaemon(true);
          nonBlockingPublishThread.setDaemon(true);
